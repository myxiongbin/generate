...
(function($) {
	...
	function _40(_41) {
		...
		var _49 = _47.children("div.datagrid-header").children(
				"div.datagrid-header-inner");
		var _4a = _48.children("div.datagrid-header").children(
				"div.datagrid-header-inner");
	...
	function _56(_57) {
		...
		_5b.find("tr[datagrid-row-index]").unbind(".datagrid").bind(
				...
				function() {
					...
					_5b.find("tr[datagrid-row-index=" + _5c + "]").addClass(
							"datagrid-row-over");
				}).bind(
				"mouseleave.datagrid",
				function() {
					var _5d = $(this).attr("datagrid-row-index");
					_5b.find("tr[datagrid-row-index=" + _5d + "]").removeClass(
							"datagrid-row-over");
		...
		_5b.find("div.datagrid-cell-check input[type=checkbox]").unbind(
				".datagrid").bind(
				"click.datagrid",
				function(e) {
					var _67 = $(this).parent().parent().parent().attr(
							"datagrid-row-index");
					if (_59.singleSelect) {
						_68(_57);
						_69(_57, _67);
	...
	function _6b(_6c) {
		...
		_6f.find("div.datagrid-cell").unbind(".datagrid")
				.bind(
						"click.datagrid",
						function() {
							...
							_6f.find("div.datagrid-cell").removeClass(
		...
		_75.children("div.datagrid-body").unbind(".datagrid").bind(
				"scroll.datagrid",
				function() {
					_74.children("div.datagrid-body").scrollTop(
							$(this).scrollTop());
					_75.children("div.datagrid-header").scrollLeft(
							$(this).scrollLeft());
					_75.children("div.datagrid-footer").scrollLeft(
							$(this).scrollLeft());
				});
		_6f
				...
				.resizable(
						{
							onStopResize : function(e) {
								...
								_7a.find("div.datagrid-header").scrollLeft(
										_7a.find("div.datagrid-body")
												.scrollLeft());
	...
	function _7b(_7c) {
		...
		function _87(col, _88) {
			col.width += _88;
			col.boxWidth += _88;
			_7f.find("td[field=" + col.field + "] div.datagrid-cell").width(
					col.boxWidth);
		}
		;
	}
	...
	function _bf(_cb) {
		...
		$("div.datagrid-body tr.datagrid-row-selected", _cd).removeClass(
	...
	$.fn.datagrid.methods = {
		...
		updateRow : function(jq, _1a2) {
			return jq
					.each(function() {
						var opts = $.data(this, "datagrid").options;
						opts.view.updateRow.call(opts.view, this, _1a2.index,
								_1a2.row);
					});
		},
	...
	var _1ac = {
		...
		refreshRow : function(_1c2, _1c3) {
			var row = {};
			var _1c4 = $(_1c2).datagrid("getColumnFields", true).concat(
					$(_1c2).datagrid("getColumnFields", false));
		...
		insertRow : function(_1ca, _1cb, row) {
			...
			var view = $(_1ca).datagrid("getPanel").children(
					"div.datagrid-view");
			...
			for ( var i = data.rows.length - 1; i >= _1cb; i--) {
				_1cd.children("div.datagrid-body").find(
						"tr[datagrid-row-index=" + i + "]").attr(
						"datagrid-row-index", i + 1);
				var tr = _1cc.children("div.datagrid-body").find(
						"tr[datagrid-row-index=" + i + "]").attr(
						"datagrid-row-index", i + 1);
				if (opts.rownumbers) {
			...
			var tr2 = "<tr datagrid-row-index=\"" + _1cb + "\">"
					...
					+ "</tr>";
			if (_1cb >= data.rows.length) {
				var _1d0 = _1cc.children("div.datagrid-body").children(
				...
				_1cc.children("div.datagrid-body").find(
						"tr[datagrid-row-index=" + (_1cb + 1) + "]")
						.before(tr1);
				_1cd.children("div.datagrid-body").find(
						"tr[datagrid-row-index=" + (_1cb + 1) + "]")
						.before(tr2);
		...
		deleteRow : function(_1d2, _1d3) {
			...
			var view = $(_1d2).datagrid("getPanel").children(
					"div.datagrid-view");
			var _1d4 = view.children("div.datagrid-view1");
			var _1d5 = view.children("div.datagrid-view2");
			_1d4.children("div.datagrid-body").find(
					"tr[datagrid-row-index=" + _1d3 + "]").remove();
			_1d5.children("div.datagrid-body").find(
					"tr[datagrid-row-index=" + _1d3 + "]").remove();
			for ( var i = _1d3 + 1; i < data.rows.length; i++) {
				_1d5.children("div.datagrid-body").find(
						"tr[datagrid-row-index=" + i + "]").attr(
						"datagrid-row-index", i - 1);
				var tr = _1d4.children("div.datagrid-body").find(
						"tr[datagrid-row-index=" + i + "]").attr(
						"datagrid-row-index", i - 1);
				if (opts.rownumbers) {
		...
		onAfterRender : function(_1d7) {
			...
			if (opts.showFooter) {
				var _1d8 = $(_1d7).datagrid("getPanel").find(
						"div.datagrid-footer");
				_1d8
						.find(
