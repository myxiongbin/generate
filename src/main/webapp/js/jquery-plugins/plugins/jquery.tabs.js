...
(function($) {
	...
	function _2c(_2d) {
		...
		$(".tabs-scroller-right", _2f).unbind(".tabs").bind(
				"click.tabs",
				function() {
	...
	function _46(_47, _48) {
		...
		pp.panel($.extend( {}, _48.options, {
			iconCls : (_48.options.icon ? _48.options.icon : undefined)
		}));
	...
	$.fn.tabs.parseOptions = function(_74) {
		var t = $(_74);
		return {
			width : (parseInt(_74.style.width) || undefined),
			height : (parseInt(_74.style.height) || undefined),
